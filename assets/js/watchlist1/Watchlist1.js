async function Watchlist1() {
  try {
    let data = await fetch("http://localhost:3000/watchList1");
    let res = await data.json();
    let watchlist1 = res.map(function (elem) {
      return `
    ...
    document
      .querySelector(".watch1wrapper")
      .insertAdjacentHTML("afterbegin", watchlist1.join());
  } catch (error) {
